...
function obtenerDatosDelServidor(datos, tiempo) {
...
function procesarDatosAsync() {
    return __awaiter(this, void 0, void 0, function () {
        var persona, numero, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, obtenerDatosDelServidor({
                ...
                case 1:
                    ...
                    return [4 /*yield*/, obtenerDatosDelServidor([1, 2, 3, 4, 5], 1000)];
                case 2:
                    numero = _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Error procesando los datos: ', error_1);
                    return [3 /*break*/, 4];
