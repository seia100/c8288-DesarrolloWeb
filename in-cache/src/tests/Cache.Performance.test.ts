// Cacher.test.ts - 
// Pruebas unitarias para Cache con concurrencia.

import { Cache } from "../cache/Cache";
//  Describe block: Agrupa las pruebas relacionadas con Cache.
describe('Cache (Concurrencia)', () => {
    let Cache: Cache<T>; //  Usar any para simplificar las pruebas con diferentes tipos.  // Tipado dinámico
 ...
 * - Se mide el tiempo de inserción de 1000 elementos en la cache.
 * - Se mide el tiempo de recuperación de los mismos 1000 elementos.
 * - Los resultados se imprimen en milisegundos, proporcionando una medida clara de rendimiento.
 */
